...
public class MappingController {
    ...
    @RequestMapping(value = {"/hello-basic", "/hello-go"}, method = RequestMethod.GET) //or연산, GET만 허용
...
//    @GetMapping("/mapping/{userId}")
//    public String mappingPath(@PathVariable String userId) // 변수명과 {} 안의 값이 같으면 @PathVariable 안에거 생략가능
